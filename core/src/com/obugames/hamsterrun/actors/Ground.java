package com.obugames.hamsterrun.actors;
...
public class Ground extends GameActor {
	...
	public Ground(Body body) {
		...
		textureRegion = new TextureRegion(new Texture(
				Gdx.files.internal(Constants.GROUND_IMAGE_PATH)));
		textureRegionBounds1 = new Rectangle(0 - getUserData().getWidth() / 2,
				0, getUserData().getWidth(), getUserData().getHeight());
	...
	private void resetBounds() {
		...
		textureRegionBounds2 = new Rectangle(textureRegionBounds1.x
				+ screenRectangle.width, 0, screenRectangle.width,
